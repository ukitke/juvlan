...
const QUESTIONS_BANK = {
    ...
    predictionFails: [
        ...
        },
        {
            ...
            correctAnswer: 1,
            explanation: '🎭 RISPOSTA DA JUVLANISTA! Se il Milan va bene, è perché "ruba".',
            juvlanistAnswer: true
        },
        {
            id: 'pred-9',
        ...
        {id: 'pred-13', type: 'infiltration', question: 'Vida: "Milan batte il Real Madrid". Real vince 3-1. Juvlanista?', options: ['Previsione ottimista', 'Il Milan è scarso, ovvio', 'Il Real è troppo forte', 'Partita equilibrata'], correctAnswer: 1, explanation: '🎭 Il Milan è sempre "scarso" per i Juvlanisti.', juvlanistAnswer: true},
        ...
        {id: 'pred-19', type: 'infiltration', question: 'Roland: "Il Milan vincerà la Coppa Italia". Eliminato ai quarti. Juvlanista?', options: ['Previsione ottimista', 'Il Milan è scarso, normale', 'Hanno incontrato squadra forte', 'Sfortuna'], correctAnswer: 1, explanation: '🎭 Il Milan è sempre "scarso".', juvlanistAnswer: true},
    ...
    controversialStatements: [
        ...
        {id: 'contro-3', type: 'infiltration', question: 'Briks: "Leão quando vuole è devastante". Juvlanista?', options: ['Vero, Leão è forte', 'Leão è un fantasma, non fa mai niente', 'Dipende dalle partite', 'Ha potenziale'], correctAnswer: 1, explanation: '🎭 Leão è sempre un "fantasma" per i Juvlanisti.', juvlanistAnswer: true},
        ...
        {id: 'contro-13', type: 'infiltration', question: 'Roland: "Maignan è il miglior portiere della Serie A". Juvlanista?', options: ['Maignan è fortissimo', 'Sommer è più affidabile', 'Sono sullo stesso livello', 'Dipende dalle partite'], correctAnswer: 1, explanation: '🎭 Mai ammettere che un milanista è il migliore!', juvlanistAnswer: true},
    ...
    playerDebates: [
        {id: 'player-1', type: 'infiltration', question: 'Briks: "Leão quando vuole è il più forte". Juvlanista?', options: ['Vero', 'Leão non fa mai niente, è un fantasma', 'Dipende dalle partite', 'Ha potenziale'], correctAnswer: 1, explanation: '🎭 Leão è sempre un "fantasma"!', juvlanistAnswer: true},
        ...
        {id: 'player-7', type: 'infiltration', question: 'Briks: "Maignan > Sommer". Juvlanista?', options: ['Vero', 'Falso, Sommer più affidabile', 'Sono simili', 'Dipende dalle partite'], correctAnswer: 1, explanation: '🎭 Mai ammettere che un milanista è meglio!', juvlanistAnswer: true},
        ...
        {id: 'player-11', type: 'infiltration', question: 'Roland: "Giroud ha fatto la differenza per il Milan". Juvlanista?', options: ['Vero', 'Giroud è finito, non conta nulla', 'Ha aiutato', 'Dipende dalle partite'], correctAnswer: 1, explanation: '🎭 I giocatori Milan sono sempre "finiti"!', juvlanistAnswer: true},
        ...
        {id: 'player-15', type: 'infiltration', question: 'Briks: "Tomori è il miglior difensore inglese in Serie A". Juvlanista?', options: ['Vero', 'Falso, è discontinuo', 'È forte', 'Dipende dalla forma'], correctAnswer: 1, explanation: '🎭 I difensori Milan sono "discontinui"!', juvlanistAnswer: true},
        {id: 'player-16', type: 'infiltration', question: 'Vida: "Reijnders è il miglior acquisto del Milan". Juvlanista?', options: ['Vero', 'È sopravvalutato', 'È un buon giocatore', 'Dipende dalle partite'], correctAnswer: 1, explanation: '🎭 Gli acquisti Milan sono sopravvalutati!', juvlanistAnswer: true},
